...
typedef ap_fixed<16,12> input_t;
typedef ap_fixed<16,10> qdense1_accum_t;
...
typedef ap_fixed<16,10> qdense2_accum_t;
typedef ap_fixed<16,10> layer5_t;
...
typedef ap_fixed<16,10> y_accum_t;
typedef ap_fixed<16,10> layer8_t;
